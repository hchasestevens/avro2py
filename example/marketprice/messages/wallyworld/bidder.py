"""Schema definitions for `marketprice.messages.wallyworld.bidder` namespace. Generated by avro2py v.0.0.6."""
import datetime
import decimal
import uuid
...
class WallyworldAdGroupStructure(NamedTuple):
    """
    Wallyworld Ad Group Structure for bidder transmission:
    wallyworld-sponsored-products-api/entity/v1/parsed-structure/ad-group
    """
    ...
    adGroupId: int
    state: str
    users_linked: List[uuid.UUID]
    adItems: List["WallyworldAdItem"]
    requestedAt: datetime.datetime
    _original_schema = (
        '{"type": "record", "name": "WallyworldAdGroupStructure", "namespace":'
        ' "marketprice.messages.wallyworld.bidder", "doc": "Wallyworld Ad Group'
        " Structure for bidder transmission:"
        ' wallyworld-sponsored-products-api/entity/v1/parsed-structure/ad-group",'
        ' "fields": [{"name": "advertiserId", "type": "long"}, {"name": "campaignId",'
        ' "type": "long"}, {"name": "adGroupId", "type": "long"}, {"name": "state",'
        ' "type": "string"}, {"name": "users_linked", "type": {"type": "array",'
        ' "items": {"type": "string", "logicalType": "uuid"}}}, {"name": "adItems",'
        ' "type": {"type": "array", "items": {"type": "record", "name":'
        ' "WallyworldAdItem", "doc": "Wallyworld Ad Item Snapshot for bidder:'
        ...
        ' "string"}, {"name": "bid", "type": {"type": "bytes", "logicalType":'
        ' "decimal", "precision": 12, "scale": 4}}, {"name": "requestedAt", "type":'
        ' {"type": "long", "logicalType": "timestamp-millis"}}]}}}, {"name":'
...
class WallyworldAdItem(NamedTuple):
    ...
    requestedAt: datetime.datetime
    _original_schema = (
        '{"type": "record", "name": "WallyworldAdItem", "doc": "Wallyworld Ad Item'
        " Snapshot for bidder:"
        ' wallyworld-sponsored-products-api/entity/v1/parsed-bidder/ad-item", "fields":'
        ' [{"name": "advertiserId", "type": "long"}, {"name": "campaignId", "type":'
        ' "long"}, {"name": "adGroupId", "type": "long"}, {"name": "adItemId", "type":'
